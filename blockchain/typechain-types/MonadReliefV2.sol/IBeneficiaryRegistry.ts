...
export interface IBeneficiaryRegistryInterface extends Interface {
...
export interface IBeneficiaryRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): IBeneficiaryRegistry;
