...
export interface MonadReliefV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "donate"
      | "donorHasDonated"
...
export interface MonadReliefV2 extends BaseContract {
  connect(runner?: ContractRunner | null): MonadReliefV2;
  waitForDeployment(): Promise<this>;

  interface: MonadReliefV2Interface;
